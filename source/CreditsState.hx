...
class CreditsState extends MusicBeatState
{
	...
	var bg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('backgrounds/Gabito')); // so that it doesnt give a damn null object reference.
	...
	{		
		...
		else if (LMAO.startsWith('Ayo') || LMAO.startsWith('FrogB'))
