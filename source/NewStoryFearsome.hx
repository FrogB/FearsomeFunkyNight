...
class NewStoryFearsome extends MusicBeatState
{
	var bg:FlxSprite;
	var week1:FlxSprite;
	var o:FlxSprite;
	...
	override function create()
	{
		...
		bg = new FlxSprite(-80).loadGraphic(Paths.image('backgrounds/Gabito'));
		bg.scrollFactor.set();
		bg.updateHitbox();
		bg.screenCenter();
		bg.color = 0xFF738BFF;
		...
		week1 = new FlxSprite(100, 70).loadGraphic(Paths.image('temp/story3'));
		...
		week2 = new FlxSprite(500, 70).loadGraphic(Paths.image('temp/story5'));
		...
		week3 = new FlxSprite(900, 70).loadGraphic(Paths.image('temp/story2'));
...
class Section2Substate extends MusicBeatSubstate
{
	...
	public function new() {
		...
		bgSub = new FlxSprite(-80).loadGraphic(Paths.image('backgrounds/Gabito'));
