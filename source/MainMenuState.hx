...
class MainMenuState extends MusicBeatState
{
	...
	public static var engineVers:Array<String> = ['Dave', 'Bambi', 'Tristan', 'Golden Tristan', 'Expunged', 'Fearsome'];
	...
	override function create()
	{
		...
		debugKeys = ClientPrefs.copyKey(ClientPrefs.keyBinds.get('debug_1')); // make it so when you press 7 INSTEAD OF 8-
